...
printf('|<i>%d&nbsp;Classes</i>|<i>%d&nbsp;gdoClasses</i>|<i>%d&nbsp;GDT</i>|<i>%d&nbsp;GDO</i>|<i>%d&nbsp;mod</i>|<i>%d&nbsp;langfs</i> ', $i['phpClasses'], $i['gdoFiles'], $i['gdtCount'], $i['gdoCount'], $i['gdoModules'], $i['gdoLangFiles']);
